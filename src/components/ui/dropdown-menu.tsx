...
import { IconArrowRight, IconCheck, IconCircle } from "@/components/ui/icons";
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <HugeIcon icon={IconArrowRight} className="ml-auto" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-32 overflow-hidden rounded-[10px] border border-border bg-popover p-2 text-popover-foreground shadow-[var(--shadow-sm)]",
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-36 overflow-hidden rounded-[10px] border border-border bg-popover p-2 text-popover-foreground shadow-[var(--shadow-sm)]",
        className
      )}
      {...props}
    />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-4 w-4 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <HugeIcon icon={IconCircle} className="fill-current" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
