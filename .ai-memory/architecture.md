...
- Extension clients bind stored sessions to the API origin and validate exchanged or cookie-derived sessions through `/api/extension/me`; `/api/extension/captures` is the single endpoint for bookmark-style saves and screenshot binaries.
